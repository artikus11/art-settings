...
Если кастомная секция содержит сложный HTML и его нужно вынести из конфигурационного файла в отдельный шаблон, укажите в `callback` подключение этого файла через `include`:
